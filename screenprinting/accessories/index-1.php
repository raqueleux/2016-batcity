	    		...
	    		<div class="row">
	    			<div class="col-md-8">
	    				<div class="row nopadding">
                            ...
                            <div class="col-md-3 nopadding col-sm-6">
		    					<div class="one-product">
		    						<a href="/screenprinting/bags/"><img src="https://unsplash.it/300/300" alt="" class="img-responsive"></a>
		    						<a href="/screenprinting/bags/" class="h6 prod-title">Bags</a>
		    					</div>
		    				</div>
		    				<div class="col-md-3 nopadding col-sm-6">
		    					<div class="one-product">
		    						<a href="/screenprinting/tops/"><img src="https://unsplash.it/300/300" alt="" class="img-responsive"></a>
		    						<a href="/screenprinting/tops/" class="h6 prod-title">Tops</a>
		    					</div>
		    				</div>
                            <div class="col-md-3 nopadding col-sm-6">
		    					<div class="one-product">
			    		...
			    		<div class="row nopadding">
                            ...
                            <div class="col-md-3 nopadding col-sm-6">
		    					<div class="one-product">
		    						<a href="/screenprinting/outer/"><img src="https://unsplash.it/300/300" alt="" class="img-responsive"></a>
		    						<a href="/screenprinting/outer/" class="h6 prod-title">Outerwear</a>
		    					</div>
		    				</div>
		    				<div class="col-md-3 nopadding col-sm-6">
		    					<div class="one-product">
